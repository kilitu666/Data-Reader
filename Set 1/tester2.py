...
def after_login(user_info, mark_unprocessed, user_name):
    ...
    The five answer possibilities lead to different results:
    1."Exit" output "see u!" and stop loop.
    2."Re-Login" coninue main menu function.
    3.Show mark records
    ...
    while True:
        ...
        #1.choose exit, stop loop
        if logged_choice == "1":
            print("==================================")
            print("See u!")
            return
        #2.Re-login means go back main menu again and stop loop
        elif logged_choice == "2":
            print("You have logged off successfully!")
            main(user_info, mark_unprocessed)(user_info, mark_unprocessed)
            return
        #3.Show mark records and continue the loop
        ...
        #4.Show summarization and continue the loop
            ...
            if assignment_choice == "A3":
                ...
                print(f"  Valid Count: {summary['valid_count']}")
                print(f"  Invalid Count: {summary['invalid_count']}")
        #If the answer is not one of these, we continue the loop


def main(user_info, mark_unprocessed):
    """
    Show the main menu at the first.
    The three answer possibilities lead to different results:
    1."Exit" output "see u!"
    2."Login" need to input the name and passport. 
        If the name or passport is wrong, the main menu will be looped
    3.Invalid input will repeat main menu.
    """
    ...
    while True:
        ...
        if login_choice == "1":
            ...
            print("See u!")
            return
        #2.choose login, input name and password.    
        elif login_choice == "2":
            print("==================================")
